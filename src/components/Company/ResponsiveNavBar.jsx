...
const DrawerIcons2 = [<ClearAllIcon />, <MenuOpenIcon />];
const DrawerIcons4 = [<PersonPinIcon />, <ExitToAppIcon />];

export default function ResponsiveNavBar({user, userData}) {
  console.log(user);
  console.log(userData);
  const [activeJobListingId, setActiveJobListingId] = useState(null);
  ...
  React.useEffect(() => {
    console.log(activeJobListingId);
  }, [activeJobListingId]);
  React.useEffect(() => {
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <Grid
            ...
            <Grid>
              ...
              <List>
                {["Job Listings", "Job Applications"].map((text, index) => (
                  <ListItem
                    key={text}
                    disablePadding
                    sx={{display: "block"}}
        ...
        <Box
          ...
          {currentTab === "Job Listings" && (
            <JobListings
              ...
              setActiveJobListingId={setActiveJobListingId}
            />
          )}
          {currentTab === "Job Applications" && (
            <JobApplication
              setCurrentTab={setCurrentTab}
              activeJobListingId={activeJobListingId}
              setActiveJobApplicationId={setActiveJobApplicationId}
            />
          )}
          {currentTab === "Profile" && <CompanyProfile />}
          {currentTab === "Interviews" && (
            <Interviews activeJobApplicationId={activeJobApplicationId} />
          )}
          {currentTab === "New Job" && <NewListingForm user={user} />}
        </Box>
      </Box>
    </Grid>
  );
